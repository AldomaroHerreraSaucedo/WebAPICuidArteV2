...
namespace WebAPICuidArte.Data
{
    public class BDInicializa
    {
        public static void Inicializar(BDContexto contexto)
        {
            ...
            {
                new AdultoMayor { Apellidos = "Gonzalez Sánchez", Nombres = "Carlos Eduardo", FechaNacimiento = "20-5-1950", Sexo = "Masculino", Peso = 75.5f, Talla = 170, Correo = "carlos.gonzalez@gmail.com", Contrasenia = "12345678" },
                new AdultoMayor { Apellidos = "Ramirez Castillo", Nombres = "Marta Isabel", FechaNacimiento = "10-5-1960", Sexo = "Masculino", Peso = 60.0f, Talla = 160, Correo = "marta.ramirez@gmail.com", Contrasenia = "12345678" }
            };
